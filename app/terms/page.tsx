    ...
    <main className="min-h-screen bg-black text-white selection:bg-indigo-500/30">
      ...
      <div className="container mx-auto max-w-4xl px-6 pt-32 pb-20">
        ...
        <div className="space-y-12 text-slate-300 leading-relaxed font-light">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">4. User Content & Intellectual Property</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-white mb-2">A. Your Content</h3>
                <p className="text-slate-400">
              ...
              <div>
                <h3 className="text-lg font-medium text-white mb-2">B. Our Intellectual Property</h3>
                <p className="text-slate-400">
          ...
          <section>
            ...
            <p className="text-slate-400 mb-4">You agree not to engage in any of the following prohibited activities:</p>
            <ul className="list-disc pl-5 space-y-2 text-slate-400 marker:text-red-500">
          ...
          <section>
            ...
            <p className="text-slate-400 uppercase text-sm tracking-wide leading-relaxed">
          ...
          <section>
            ...
            <p className="text-slate-400">
              Questions about the Terms of Service should be sent to us at <a href="mailto:legal@betsyai.com" className="text-indigo-400 hover:text-indigo-300 transition-colors">legal@betsyai.com</a>.
            </p>
          </section>
        </div>
      </div>
