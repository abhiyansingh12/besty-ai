    ...
    return (
        <main className="min-h-screen bg-slate-50 text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <div className="container mx-auto max-w-4xl px-6 pt-32 pb-20">
                <h1 className="text-4xl md:text-5xl font-bold mb-8 tracking-tight text-slate-900">Privacy Policy</h1>
                ...
                <div className="space-y-12 text-slate-700 leading-relaxed font-light">
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-lg font-medium text-slate-900 mb-2">A. Personal Information</h3>
                                <p className="text-slate-600">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-slate-900 mb-2">B. User Content (Documents & Data)</h3>
                                <p className="text-slate-600">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-slate-900 mb-2">C. Usage & Technical Data</h3>
                                <p className="text-slate-600">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-3 text-slate-600 marker:text-indigo-600">
                            <li>
                                <strong className="text-slate-900">To Provide and Manage the Service:</strong> We use your information to facilitate account creation, authentication, and the core functionality of processing your uploaded documents.
                            </li>
                            <li>
                                <strong className="text-slate-900">To Improve Our AI Models:</strong> We may use aggregated, anonymized usage data to improve the performance and accuracy of our AI systems. We do <strong>not</strong> access your raw private documents for model training purposes.
                            </li>
                            <li>
                                <strong className="text-slate-900">To Communicate with You:</strong> We may use your information to send you administrative information, such as product updates, security alerts, and support responses.
                            </li>
                            <li>
                                <strong className="text-slate-900">To Enforce Our Terms:</strong> We may use your information to ensure compliance with our Terms of Service and to prevent malicious or illegal activity.
                            </li>
                            <li>
                                <strong className="text-slate-900">Legal Obligations:</strong> We may disclose information where we are legally required to do so in order to comply with applicable law, governmental requests, a judicial proceeding, court order, or legal process.
                            </li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-2xl font-semibold text-slate-900 mb-4">4. Data Retention & Security</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-slate-900 mb-4">5. Your Privacy Rights</h2>
                        <p className="text-slate-600">
                    ...
                    <section>
                        ...
                        <p className="text-slate-600">
                            If you have questions or comments about this policy, you may email us at <a href="mailto:support@betsyai.com" className="text-indigo-600 hover:text-indigo-500 transition-colors">support@betsyai.com</a>.
                        </p>
                    </section>
                </div>
            </div>
